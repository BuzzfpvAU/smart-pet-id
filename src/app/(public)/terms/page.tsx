...
export default function TermsPage() {
  return (
    <div className="container max-w-3xl py-24 md:py-36 prose prose-sm dark:prose-invert">
      <h1 className="font-display tracking-tight">Terms of Service</h1>
      <p className="text-muted-foreground">
        Last updated: {new Date().toLocaleDateString()}
      </p>

      <h2 className="font-display tracking-tight">1. Acceptance of Terms</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">2. Service Description</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">3. User Accounts</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">4. Privacy</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">5. Location Data</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">6. User Content</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">7. Prohibited Use</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">8. Limitation of Liability</h2>
      <p>
      ...
      <h2 className="font-display tracking-tight">9. Changes to Terms</h2>
      <p>
        We reserve the right to modify these terms at any time. Continued use of
        the service after changes constitutes acceptance of the modified terms.
      </p>

      <h2 className="font-display tracking-tight">10. Contact</h2>
      <p>
